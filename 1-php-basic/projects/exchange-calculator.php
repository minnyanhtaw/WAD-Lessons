...
<div class="bg-gray-50 p-5 rounded">
  ...
  <form action="" method="post">
    <div class="flex flex-col gap-5">
      <div class="max-w-sm">
        <label for="amount" class="block text-sm font-medium mb-2 dark:text-white">Email</label>
        <input type="number" id="amount" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-neutral-900 dark:border-neutral-700 dark:text-neutral-400 dark:placeholder-neutral-500 dark:focus:ring-neutral-600" placeholder="Enter your amount" />
      </div>
      ...
      <button type="submit" class="py-3 px-4 inline-flex items-center gap-x-2 text-sm font-semibold rounded-lg border border-transparent bg-blue-600 text-white hover:bg-blue-700 disabled:opacity-50 disabled:pointer-events-none w-full justify-center">
        Exchange
      </button>
    </div>
  </form>
