    ...
    <main class=" max-[1000px] mx-auto border py-10 px-3">
        ...
        <section class="px-4 pb-4 pt-2 sm:ml-64">
            ...
            <div class=" bg-gray-100 py-4 rounded-lg">
                ...
                <div class="px-4 grid place-items-center">
                    <p class="text-3xl text-center font-bold"> <?= $area ?> Sqft</p>
                    <a href="./index.php"
                        class="px-4 text-center py-2 w-full bg-blue-500 text-white rounded-lg mt-5">Calculate again</a>
                </div>
            </div>
        </section>
    </main>
